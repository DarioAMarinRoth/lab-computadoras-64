...
```bash
git clone https://github.com/DarioAMarinRoth/lab-computadoras-64.git
```
...
Para cualquier pregunta o sugerencia, contactame por correo electrónico: [laboratoriodecomputadoraselectronicas64@epet14.edu.ar](mailto:laboratoriodecomputadoraselectronicas64@epet14.edu.ar).
